...
The genome was broken in to 1703 regions (using Pickrell's `ldetect`). `susie` was run on the top 15 loci, after generating priors using `torus`.  `susie` was run assuming 1 causal variant per locus.  
...
1. `chip-seq-reproducible-ctr-H3K4me1`
2. `eQTL_0.05_FDR`                    
3. `Repressed_Hoffman`
4. `chip-seq-reproducible-dec-H3K4me1`
